...
public class Customer {
    ...
    private int age;
    public List<Flight> flightsRegByUser;
    ...
    Customer(String name, String email, String password, String phone, String address, int age) {
        ...
        this.age = age;
        this.flightsRegByUser = new ArrayList<>();
    ...
    // getters and setters
    public List<Flight> getFlightsRegByUser() {
        return flightsRegByUser;
    }
