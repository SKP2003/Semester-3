...
public class Flight extends FlightDistance {
    ...
    public String[] calculateDistance(double lat1, double lon1, double lat2, double lon2) {
        ...
        // On the Zero-Index, distance will be in Miles, on 1st-index, distance will be in KM and on the 2nd index
        // distance will be in KNOTS
    ...
    public List<Customer> getListOfRegCustomersInAFlight() {
